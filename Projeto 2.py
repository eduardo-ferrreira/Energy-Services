...
d = {'Methods': ['Bootstrapping', 'Random Forest', 'Gradient Boosting'], 'MAE': [MAE_BT, MAE_RF, MAE_GB],
     'MSE': [MSE_BT, MSE_RF, MSE_GB], 'RMSE': [RMSE_BT, RMSE_RF, RMSE_GB],'cvMSE': [cvRMSE_BT, cvRMSE_RF, cvRMSE_GB]}
...
df_results = df_results.iloc[:, [1, 0, 2, 3, 4]]
